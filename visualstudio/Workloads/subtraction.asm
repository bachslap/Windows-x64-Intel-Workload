...
subtractionwl proc   ;defines a function

	mov rcx, 10000000000   ;loop counter, must be stored in ecx register
	mov rax, 10000    ;addition variable
	...
	L1:			  ;I believe this colon defines a section of code
		...
		dec rax   ;adds one to the value stored in register rax
...
subtractionwl endp   ;end the function
end